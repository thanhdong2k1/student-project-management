...
const ProjectManagement = () => {
  ...
  const handleDownload = (event) => {
    ...
    window.open(
      `http://phuongnamdts.com:5000/${rowDetail.pathSoftCopy}`,
      "_blank"
    );
  };
  return (
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={8} sx={{ overflow: "hidden" }}>
              {rowDetail.nameBanMem && (
                <Button3D sx={{ maxWidth: "100%" }}>
                  <Link
                    href={`http://phuongnamdts.com:5000/${rowDetail.pathBanMem}`}
                    target="_blank"
                    download
                    underline="none"
            ...
            <Grid item xs={8} sx={{ overflow: "hidden" }}>
              {rowDetail.nameBienBan && (
                <Button3D sx={{ maxWidth: "100%" }}>
                  <Link
                    href={`http://phuongnamdts.com:5000/${rowDetail.pathBienBan}`}
                    target="_blank"
                    download
                    underline="none"
                    sx={{ ml: 1, maxWidth: "100%" }}
            ...
            {/* <iframe
                  src={`http://phuongnamdts.com:5000/${rowDetail.pathMinutes}`}
                  width="100%"
                  height="500px"
                  /> */}
            <Grid item xs={4}>
